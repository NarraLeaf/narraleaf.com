...
because serving them here is redistribution too.
...
table is here for provenance.

## Character — NarraLeaf's own

`demo-narra.webp` — Narra, the project's mascot, supplied by the project owner.
Upper body, transparent background, trimmed of its empty margin and encoded to
WebP at 1100px tall.
