...
const homeCopy = {
  ...
  ja: {
    hero: {
      ...
      description:
        'ビジュアルノベルの制作、配信、組み込みを、一つのプロジェクト基盤でまかないます。',
      ...
      groups: [
        ...
        },
        {
          ...
          slideAlts: [
            ...
            'ストーリーランタイムのインスペクタを開いた状態で Dev Mode がゲームを実行している様子',
            '配布用にプロジェクトをビルドする様子',
          ],
        },
      ],
    ...
    desktopIntro: {
      ...
      description:
        'ウィンドウのライフサイクル、セーブデータ、ルーティング、メニュー、パッケージングが、プレビューからそのまま配信する NarraLeaf ランタイムに組み込まれた、デスクトップ向けのプロジェクトです。',
      cta: 'Desktop を見る',
      href: '/narraleaf/library/main',
    ...
    projectModelTabs: [
      ...
      },
      {
        ...
        description:
          'React は、周囲のアプリをビジュアルノベルエンジンに仕立てることなく、ストーリーを Web 製品に持ち込むためのものです。',
        points: [
          '既存の React の画面にプレイヤーを組み込みます。',
          'ホストとなるアプリ側で、レイアウト、データ、認証、製品側の UI を管理し続けられます。',
