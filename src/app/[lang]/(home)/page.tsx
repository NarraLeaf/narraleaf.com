  ...
  ja: {
    ...
    editorIntro: {
      ...
      groups: [
        {
          ...
          slideAlts: [
            '台詞行とキャラクター差分を並べたストーリーエディタ',
            'エディタの隣で現在のシーンを再生するステージプレビュー',
            'キャラクターの移動を時間軸に並べるモーションエディタ',
            'ランタイムを導入し、ステージに配置した Live2D キャラクター',
            'シーン数、文字数、アセット数、ブループリントのノード数を集計する一覧画面',
          ],
        },
        {
          id: 'customize',
        ...
        },
        {
          ...
          slideAlts: [
            '審査と承認を待つ訳文が並ぶローカライズ画面',
            'アセットライブラリと音声波形の隣に並ぶバージョン履歴',
            'ストーリーランタイムの検査画面を開いたまま Dev Mode でゲームを実行',
            '配布用にプロジェクトを構築している様子',
          ],
        },
      ],
      slideControls: {
        ...
        openPreview: 'Studio プレビューを拡大',
        closePreview: '拡大表示を閉じる',
      },
    },
    desktopIntro: {
      eyebrow: 'Desktop',
      title: 'NarraLeaf Desktop は、コードと動くゲームを並べる',
      description:
        'プレイヤーが起動するのは Desktop が作ったアプリです。ウィンドウの扱いも、セーブも、パッケージングも、プロジェクト自身のコードに書かれています。',
      cta: 'Desktop を見る',
      href: '/narraleaf/library/main',
      codeImageAlt: 'NarraLeaf Desktop の入口ファイルを開いた VS Code のウィンドウ',
      demoSlideAlts: [
        '対話画面を開いた NarraLeaf Desktop のビジュアルノベルのデモ',
        '読み込みメニューを表示した NarraLeaf Desktop のビジュアルノベルのデモ',
      ],
      slideControls: {
    ...
    projectModelTabs: [
      {
        ...
        tone: 'studio',
        logo: 'narraleaf',
        title: 'NarraLeaf Studio が制作を受け持つ',
        description: '制作に必要なものが、同じワークスペースにまとまります。',
        points: [
          'シーンと画面を組み立てるその場で、アセットを管理します。',
          '画面の編集と物語づくりを同時に進めます。',
          'チームの共同作業を制作の現場に残し、道具を渡り歩かずに済みます。',
        ],
      },
      {
        label: 'NarraLeaf Desktop',
        ...
        tone: 'electron',
        logo: 'electron',
        title: 'NarraLeaf Desktop が配布を受け持つ',
        description:
          'Desktop はプレイヤーが実際に起動するアプリです。ウィンドウの振る舞いもパッケージングも Desktop が担います。',
        points: [
          '遊べるアプリを、それを制御するコードの隣で構築します。',
          'Electron、レンダラー、NarraLeaf ランタイムの判断を一箇所にまとめます。',
          'ビジュアルノベル自体が製品であるときに選びます。',
        ],
      },
      {
        label: 'NarraLeaf-React',
        ...
        tone: 'react',
        logo: 'react',
        title: 'NarraLeaf-React が組み込み再生を受け持つ',
        description:
          '物語を Web 製品に持ち込みます。製品側をビジュアルノベルエンジンに作り替える必要はありません。',
        points: [
          '既存の React 画面に、そのまま組み込めます。',
          '外側のアプリは、配置、データ、認証、製品の UI を持ったままです。',
          '物語が製品の一部であるときに選びます。',
        ],
      },
    ],
    solutions: [
      {
        title: 'NarraLeaf Studio',
        description: 'ビジュアルノベルを仕上げるための制作エディタです。',
        audience: '制作を一箇所にまとめたいチームに向いています。',
        href: '/studio',
        cta: 'Studio を見る',
        tone: 'studio',
        logo: 'narraleaf',
      ...
      {
        title: 'NarraLeaf Desktop',
        description: 'ビジュアルノベルを単体のデスクトップアプリとして配布します。',
        audience: 'ビジュアルノベル自体が製品となるプロジェクトに向いています。',
        href: '/narraleaf/library/main',
        cta: 'Desktop を見る',
        tone: 'electron',
        logo: 'electron',
      ...
      {
        title: 'NarraLeaf-React',
        description: '物語を既存の React 画面に組み込みます。',
        audience: '物語が製品の一部であるチームに向いています。',
        href: '/narraleaf-react',
        cta: 'React プレイヤーを見る',
        tone: 'react',
        logo: 'react',
    ...
    embedDemo: {
      eyebrow: 'React プレイヤー',
      title: 'NarraLeaf-React は、このページの中で動いている',
      description: 'あなたの React 画面と並んで動き、表示はすべて脚本が決めます。',
      code: [
        'introScene.background.char("/room.jpg", new FadeIn(600)),',
        '',
        'narraImage.show({ duration: 600 }),',
