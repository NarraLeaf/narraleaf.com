---
title: "Plugin"
description: The plugin system, covering a plugin's register and unregister methods, and registering it on the Game instance.
---
...
For detailed information about hooks, please refer to the [Hooks](/docs/narraleaf-react/core/game/hooks) documentation.
