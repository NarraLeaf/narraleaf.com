...
- `easing?: TransformDefinitions.EasingDefinition` - The easing function. See [EasingDefinition](/docs/narraleaf-react/core/types/EasingDefinition).
- Returns `Transform<T>`
</Step>
</Steps>
...
- `config?: Partial<TransformDefinitions.TransformConfig>` - The transform config. See [TransformConfig](/docs/narraleaf-react/core/types/TransformDefinitions).
- Returns `Transform<T>`
</Step>
</Steps>
...
- `options?: Partial<TransformDefinitions.SequenceOptions>` - Sequence timing options. See [SequenceOptions](/docs/narraleaf-react/core/types/TransformDefinitions).
- Returns `this`
</Step>
</Steps>
