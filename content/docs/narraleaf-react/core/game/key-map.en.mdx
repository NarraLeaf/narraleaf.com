---
title: "KeyMap"
description: KeyMap methods for setting, reading, and matching keyboard bindings for game actions.
---
...
See [`useKeyBinding`](/docs/narraleaf-react/player/hooks/useKeyBinding) for a convenient React hook that automatically updates your UI when a binding changes.
