...
- `persistent: Persistent<any>` - The [Persistent](./persistent) to be registered
- Returns `this`
</Step>
</Steps>
...
Register a service. For more information, see [Service](./service).
...
- `service: Service<any>` - The [Service](./service) to be registered
- Returns `this`
</Step>
</Steps>
