---
title: "Story"
description: The `Story` class, the entry point for a game, covering scene entry, persistent and service registration, and save-compatibility hashing.
---
...
- `config: IStoryConfig` - See [IStoryConfig](/docs/narraleaf-react/core/types/IStoryConfig)
</Step>
</Steps>
...
- `persistent: Persistent<any>` - The [Persistent](/docs/narraleaf-react/core/elements/persistent) to be registered
- Returns `this`
</Step>
</Steps>
...
Register a service. For more information, see [Service](/docs/narraleaf-react/core/elements/service).
...
- `service: Service<any>` - The [Service](/docs/narraleaf-react/core/elements/service) to be registered
- Returns `this`
</Step>
</Steps>
