...
有关 ServiceHandlerCtx 的详细信息，请参见 [ServiceHandlerCtx](/zh/docs/narraleaf-react/core/types/ServiceHandlerCtx)
...
- `key: K` - 操作键
- `handler: ServiceHandler<Content[K]>` - 有关 ServiceHandler 的详细信息，请参见 [ServiceHandlerCtx](/zh/docs/narraleaf-react/core/types/ServiceHandlerCtx)
- 返回 `this`
</Step>
</Steps>
