---
title: "Menu"
description: The `Menu` class for branching player choices, covering prompts, conditional visibility, and enabling of individual options.
---
...
- `config?: MenuConfig` - [MenuConfig](/docs/narraleaf-react/core/types/MenuConfig)
</Step>
</Steps>
...
- `prompt: SentencePrompt` - See [SentencePrompt](/docs/narraleaf-react/core/types/SentencePrompt)
- `config?: MenuConfig` - [MenuConfig](/docs/narraleaf-react/core/types/MenuConfig)

#### Overload 2 of 5

- `prompt: Sentence` - The prompt of the menu, See [Sentence](/docs/narraleaf-react/core/elements/character/sentence)
- `config?: MenuConfig` - [MenuConfig](/docs/narraleaf-react/core/types/MenuConfig)
...
- `choice: MenuChoice` - The choice of the menu, See [MenuChoice](/docs/narraleaf-react/core/types/MenuChoice)
...
- `prompt: Sentence` - The prompt of the choice, See [Sentence](/docs/narraleaf-react/core/elements/character/sentence)
- `action: ActionStatements` - The action of the choice, See [ActionStatements](/docs/narraleaf-react/core/types/ActionStatements)
