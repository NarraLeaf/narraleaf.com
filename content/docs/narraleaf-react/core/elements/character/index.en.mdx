---
title: "Character"
description: The `Character` class for dialogue, covering sentences, naming, and dialog-box avatar and portrait bindings.
---
<Cards>
    <Card
        title="Sentence"
    ...
    <Card
        title="TextEvent"
        href="/docs/narraleaf-react/core/elements/character/text-event"
    />
</Cards>
