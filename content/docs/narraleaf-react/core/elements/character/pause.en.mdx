---
title: "Pause"
description: The `Pause` token for a timed or click-to-continue pause inside a `Character` sentence.
---
...
- `config?: Partial<PauseConfig>` - [PauseConfig](/docs/narraleaf-react/core/types/PauseConfig)
</Step>
</Steps>
