...
The background music of the scene. See [Sound](/zh/docs/narraleaf-react/core/elements/sound).
...
Background image or color. See [Background](/zh/docs/narraleaf-react/core/types/Background).
