---
title: "IPosition"
description: The three position representations an element accepts, `CommonPosition`'s named presets, `Align`'s fractional alignment, and `Coord2D`'s absolute coordinates.
---
