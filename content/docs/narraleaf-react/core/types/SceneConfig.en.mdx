...
The background music of the scene. See [Sound](/docs/narraleaf-react/core/elements/sound).
...
Background image or color. See [Background](/docs/narraleaf-react/core/types/Background).
