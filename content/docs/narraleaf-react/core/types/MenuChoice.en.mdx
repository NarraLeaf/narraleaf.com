---
title: "MenuChoice"
description: "One option added with `Menu.choose`: its prompt, its action list, and the lambdas that disable or hide it."
---
```ts
type MenuChoice = {
...
For more information about `ActionStatements`, see [ActionStatements](/docs/narraleaf-react/core/types/ActionStatements).
