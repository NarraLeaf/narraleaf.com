---
title: "ITransition"
description: The deprecated interface for implementing a custom image or scene transition, superseded by the built-in transition classes.
---
...
Here is an example of [Dissolve.ts](https://github.com/NarraLeaf/narraleaf-react/blob/master/src/game/nlcore/elements/transition/transitions/image/dissolve.ts): 
...
You can create your own transition effect by implementing the [ITransition](https://github.com/NarraLeaf/narraleaf-react/blob/master/src/game/nlcore/elements/transition/type.ts) interface and extends a transition base class such as [ImageTransition](https://github.com/NarraLeaf/narraleaf-react/blob/master/src/game/nlcore/elements/transition/transitions/image/imageTransition.ts).
