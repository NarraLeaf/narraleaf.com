---
title: "GameConfig"
description: The full set of options passed to `new Game()`, covering player dimensions, preloading, audio buses, skip behavior, and replaceable UI components.
---
```typescript
type GameConfig = {
    /**
     ...
     * played between scenes by Scene.jumpTo
     * @default true
     */
...
- For `AudioBusDeclaration`, see [AudioBusDeclaration](/docs/narraleaf-react/core/types/AudioBusDeclaration) and [Audio Buses](/docs/narraleaf-react/core/game/audio-buses).
