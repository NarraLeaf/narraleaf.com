---
title: "LambdaHandler"
description: "The function signature `(ctx: LambdaCtx) => T`, used to compute conditions, menu choice guards, and other context-dependent values."
---
```typescript
...
For more information about the context object, see [LambdaCtx](/docs/narraleaf-react/core/types/LambdaCtx) and [ScriptCtx](/docs/narraleaf-react/core/types/ScriptCtx).
