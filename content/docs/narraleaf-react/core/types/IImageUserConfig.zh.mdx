...
description: Image 元素的用户配置，涵盖来源、图层、自适应、暗度与初始化行为
---
```typescript
...
关于 CommonDisplayableConfig，参见 [CommonDisplayableConfig](/zh/docs/narraleaf-react/core/types/CommonDisplayableConfig)
