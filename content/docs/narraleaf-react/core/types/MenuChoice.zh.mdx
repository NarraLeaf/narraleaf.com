---
title: "MenuChoice"
description: "`Menu.choose` 添加的单个选项：提示文本、动作列表，以及控制禁用或隐藏的条件"
---
```ts
type MenuChoice = {
...
有关 `ActionStatements` 的更多信息，请参见 [ActionStatements](/zh/docs/narraleaf-react/core/types/ActionStatements)
