...
description: The opacity, scale, rotation and position properties an image transform animates between.
---
```ts
...
The position of the image. See [IPosition](/docs/narraleaf-react/core/types/IPosition)
