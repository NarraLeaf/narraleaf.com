...
title: "播放故事"
---
You can wrap your entry scene with a [Story](/zh/docs/narraleaf-react/core/elements/story) instance to create a story. 
...
[GameProviders](/zh/docs/narraleaf-react/player/game-providers) 组件是播放故事所必需的。它为播放器和钩子提供了上下文。
