...
title: "Make Choices"
---
You can crerate a menu with choices by using the [Menu](/docs/narraleaf-react/core/elements/menu) element.
...
You can show the menu prompt with a custom [Sentence](/docs/narraleaf-react/core/elements/character/sentence).
