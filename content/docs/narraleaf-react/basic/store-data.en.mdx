...
title: "Store Data"
---
You can use [Persistent](/docs/narraleaf-react/core/elements/persistent) to store data in the game context.
...
<Callout type="warning">
    If the script content contains Persistent, it must be registered with [Story](/docs/narraleaf-react/core/elements/story) using `story.registerPersistent(persis)`.
</Callout>

> **Note:** The stored content must be **serializable**, for more information, see [Persistent](/docs/narraleaf-react/core/elements/persistent).
