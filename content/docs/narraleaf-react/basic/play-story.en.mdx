...
title: "Play Story"
---
You can wrap your entry scene with a [Story](/docs/narraleaf-react/core/elements/story) instance to create a story. 
...
The [GameProviders](/docs/narraleaf-react/player/game-providers) component is required to play the story. It provides the context for the player and hooks to work.
