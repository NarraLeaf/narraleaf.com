...
---
[Scene](/docs/narraleaf-react/core/elements/scene) is the basic element of NarraLeaf-React. It defines a period of time and background.
...
The second parameter is an optional configuration. You can find the config doc [here](/docs/narraleaf-react/core/types/SceneConfig).
