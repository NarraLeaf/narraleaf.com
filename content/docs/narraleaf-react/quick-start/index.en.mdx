---
title: Quick Start
description: Scaffold a project with nlr-skeleton, run the dev server, and edit your first story.
---
...
**Core** and **Player** chapters are not migrated in this batch; they will appear in the sidebar as the documentation import continues.
