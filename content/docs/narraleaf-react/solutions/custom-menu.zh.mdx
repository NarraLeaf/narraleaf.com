...
本文档演示如何使用 [GameMenu](/zh/docs/narraleaf-react/player/menu) 和 [Item](/zh/docs/narraleaf-react/player/menu) 构建自定义菜单，并支持 `bindKey` 快捷键。
...
注册时可设置 [defaultMenuChoiceColor](/zh/docs/narraleaf-react/core/game/game) 控制选项默认颜色：
