...
注册时还可设置 [defaultTextColor](/zh/docs/narraleaf-react/core/game/game)、[defaultNametagColor](/zh/docs/narraleaf-react/core/game/game) 等默认颜色：
...
- **名牌颜色**：由 [Character](/zh/docs/narraleaf-react/core/elements/character) 配置中的 `nametagColor` 控制，不建议用 CSS 覆盖。
- **文本样式**：由 [Word](/zh/docs/narraleaf-react/core/elements/character/word) / [Sentence](/zh/docs/narraleaf-react/core/elements/character/sentence) 配置控制，可自定义背景、字体、大小等未预定义属性。
