...
This guide shows how to build a custom menu with [GameMenu](/docs/narraleaf-react/player/menu) and [Item](/docs/narraleaf-react/player/menu), including `bindKey` support for keyboard shortcuts.
