---
title: "GameProviders"
description: The GameProviders component that supplies a Game instance to Player and other components, including the game prop for reusing an existing instance.
---
...
The [Game](/docs/narraleaf-react/core/game/game) instance that you want to use.
