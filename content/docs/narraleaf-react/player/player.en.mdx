...
If you are creating a story using abstract classes, please check the [Core](../core) documentation.
...
For example, you can use [PageRouter API](./page-router) to create your own quick menu. 
