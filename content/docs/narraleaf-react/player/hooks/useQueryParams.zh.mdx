...
description: useQueryParams 钩子，返回 LayoutRouter 查询参数并随其变化更新
---
...
参见：[`usePathname`](/zh/docs/narraleaf-react/player/hooks/usePathname) • [`useParams`](/zh/docs/narraleaf-react/player/hooks/useParams)
