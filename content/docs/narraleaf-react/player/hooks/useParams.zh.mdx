---
title: "useParams"
description: useParams 钩子，返回当前 Layout 路径模式捕获到的参数
---
...
参见：[`usePathname`](/zh/docs/narraleaf-react/player/hooks/usePathname) • [`useQueryParams`](/zh/docs/narraleaf-react/player/hooks/useQueryParams)
