...
description: The useQueryParams hook, which returns the current LayoutRouter query parameters and updates as they change.
---
...
See also: [`usePathname`](/docs/narraleaf-react/player/hooks/usePathname) • [`useParams`](/docs/narraleaf-react/player/hooks/useParams)
