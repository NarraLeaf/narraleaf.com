...
description: An overview of the LayoutRouter page routing API, its nested Layout and Page components, path patterns, and migration from PageRouter.
---
`LayoutRouter` works together with `Layout` and `Page` components to build a tree-like UI structure. It is the recommended page routing API for menus, settings screens, galleries, and layered game UI.

This document gives a quick overview; detailed APIs are in:

- [`LayoutRouter`](/docs/narraleaf-react/player/page-router/router)
- [`Layout`](/docs/narraleaf-react/player/page-router/layout)
- [`Page`](/docs/narraleaf-react/player/page-router/page)
...
1. Read the [`LayoutRouter` public methods](/docs/narraleaf-react/player/page-router/router#public-methods).
2. Learn about [`Layout`](/docs/narraleaf-react/player/page-router/layout) and path patterns.
