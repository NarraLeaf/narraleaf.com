...
| `game.story` | `story.compile` | [Runtime API](/zh/docs/studio/plugin/runtime) |
| `game.navigation` | 无——只需一个非空的 `contributes.externalLinks` | [Runtime API](/zh/docs/studio/plugin/runtime) |
