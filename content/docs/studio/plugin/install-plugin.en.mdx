...
<Figure
    ...
    alt="The launcher's Plugins page on the Installed list, with the built-in plugins marked"
/>
...
<Figure
    ...
    alt="The Store list, with one plugin offering Install and the already-installed ones marked"
/>
...
<Figure
    brief="The permission prompt for a plugin that asks for several capabilities, showing a filesystem path, a runtime capability, and a bundled native program in one list."
/>
