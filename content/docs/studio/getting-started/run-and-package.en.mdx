...
The dialog also lists the bundled plugins, locales, network policy, and asset protection. A Web build is a deployable static site, and asset protection does not apply to it. Asset protection does not apply to Android and iOS builds either.
</Step>
<Step>
