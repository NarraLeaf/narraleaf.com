...
The game's folder is the one holding its `resources` folder. On Windows and Linux the executable is in that folder. On macOS it is `Contents`, inside the app bundle.
