...
description: Button label and pointer, container clipping, and the Page a Frame shows — all on a wired element.
---

Three small property surfaces: a Button's label and cursor, a Container's clipping, and the Page a Frame shows. The rules common to every Element node are in [Element](/docs/studio/blueprint/nodes/element).
