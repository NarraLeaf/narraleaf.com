...
Neither is an event head. To *react* to input, use the keyboard and pointer heads in [Events](/docs/studio/blueprint/nodes/events); these two answer "what is true right now", which is what a binding on a widget's appearance wants.
