...
<Figure
    ...
    alt="The Studio workspace: activity bar, Story panel, an open scene, and the Properties panel"
/>
...
<Figure
    ...
    alt="Dev Mode running the project's title screen in a separate window"
/>
